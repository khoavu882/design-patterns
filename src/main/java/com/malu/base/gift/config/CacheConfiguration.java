...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, com.malu.base.gift.domain.Gift.class.getName(), jcacheConfiguration);
            createCache(cm, com.malu.base.gift.domain.Gift.class.getName() + ".languages", jcacheConfiguration);
            createCache(cm, com.malu.base.gift.domain.GiftSeason.class.getName(), jcacheConfiguration);
            createCache(cm, com.malu.base.gift.domain.GiftSeason.class.getName() + ".gifts", jcacheConfiguration);
